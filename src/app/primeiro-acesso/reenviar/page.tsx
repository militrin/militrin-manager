    ...
    <main className="min-h-screen bg-slate-950 px-4 py-8 text-slate-100">
      <section className="mx-auto max-w-md rounded-3xl border border-slate-800 bg-slate-900 p-6 text-center">
        ...
        <p className="mt-2 text-sm text-slate-300">
          Informe o e-mail do convite. Se ainda houver primeiro acesso pendente, enviaremos um novo link. O convite interno pode continuar válido mesmo depois que o link anterior expirar.
        </p>
        <ResendInviteForm />
      </section>
    </main>
