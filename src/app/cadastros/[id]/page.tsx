...
export default async function CadastroDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [{ data: contact, error: contactError }, { data: ticketRows, error: ticketsError }, { data: linkedParticipants, error: participantsError }, canIssueTicket] = await Promise.all([
