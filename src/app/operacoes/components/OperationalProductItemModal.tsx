...
import { deliverOperationalProductItemAction } from "../actions";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/85 p-4">
      <div className="w-full max-w-md rounded-3xl border border-slate-700 bg-slate-900 p-5 shadow-2xl">
        <div className="flex items-center justify-between">
          ...
          {alreadyDelivered ? <p className="text-xs font-bold uppercase tracking-wide text-cyan-300">Item já entregue</p> : null}
        </div>
