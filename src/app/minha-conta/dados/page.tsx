  ...
  return (
    <section className="space-y-4">
      ...
      >
        ...
        {publicPin ? <div className="mb-5 rounded-2xl border border-emerald-500/25 bg-emerald-500/5 p-4"><p className="text-xs uppercase tracking-wider text-emerald-300">PIN da conta</p><p className="mt-1 font-mono text-xl font-semibold tracking-[0.2em] text-white">{publicPin}</p><p className="mt-1 text-xs text-slate-400">PIN da sua conta Militrin. Não identifica um ingresso e não é uma senha.</p></div> : null}
