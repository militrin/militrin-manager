...
const aliases: Record<CanonicalField, string[]> = {
  ...
  cpf: ['cpf', 'documento'],
  email: ['email', 'e-mail', 'mail', 'endereco de e-mail', 'endereco de email'],
  ...
  batch: ['lote', 'batch'],
  shirt_type: ['camiseta', 'tipo de camiseta', 'shirt_type', 'modelo camiseta', 'tipo'],
  shirt_size: ['tamanho', 'shirt_size', 'tam camiseta', 'tamanho camiseta'],
