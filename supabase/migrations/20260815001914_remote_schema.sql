...
drop policy "coupon_redemptions_read_only" on "public"."coupon_redemptions";

drop policy "coupons_read_only" on "public"."coupons";

drop policy "event_attractions_read_only" on "public"."event_attractions";

drop policy "event_kit_item_variants_read_only" on "public"."event_kit_item_variants";

drop policy "event_kit_items_read_only" on "public"."event_kit_items";

drop policy "registration_batch_prices_read_only" on "public"."registration_batch_prices";

drop policy "registration_batches_read_only" on "public"."registration_batches";

drop policy "shirt_inventory_read_only" on "public"."shirt_inventory";

drop policy "ticket_categories_read_only" on "public"."ticket_categories";

drop policy "ticket_category_benefits_read_only" on "public"."ticket_category_benefits";
...
revoke references on table "public"."admin_user_permission_overrides" from "anon";

revoke trigger on table "public"."admin_user_permission_overrides" from "anon";

revoke truncate on table "public"."admin_user_permission_overrides" from "anon";

revoke references on table "public"."admin_user_permission_overrides" from "authenticated";

revoke trigger on table "public"."admin_user_permission_overrides" from "authenticated";

revoke truncate on table "public"."admin_user_permission_overrides" from "authenticated";
...
revoke references on table "public"."financial_entry_settlements" from "anon";

revoke trigger on table "public"."financial_entry_settlements" from "anon";

revoke truncate on table "public"."financial_entry_settlements" from "anon";
...
revoke references on table "public"."participant_account_invites" from "anon";

revoke trigger on table "public"."participant_account_invites" from "anon";

revoke truncate on table "public"."participant_account_invites" from "anon";

revoke references on table "public"."participant_account_invites" from "authenticated";

revoke trigger on table "public"."participant_account_invites" from "authenticated";

revoke truncate on table "public"."participant_account_invites" from "authenticated";

revoke references on table "public"."platform_users" from "anon";

revoke trigger on table "public"."platform_users" from "anon";

revoke truncate on table "public"."platform_users" from "anon";

revoke references on table "public"."platform_users" from "authenticated";

revoke trigger on table "public"."platform_users" from "authenticated";

revoke truncate on table "public"."platform_users" from "authenticated";

revoke references on table "public"."user_pin_lookup_attempts" from "anon";

revoke trigger on table "public"."user_pin_lookup_attempts" from "anon";

revoke truncate on table "public"."user_pin_lookup_attempts" from "anon";

revoke references on table "public"."user_pin_lookup_attempts" from "authenticated";

revoke trigger on table "public"."user_pin_lookup_attempts" from "authenticated";

revoke truncate on table "public"."user_pin_lookup_attempts" from "authenticated";
...
using (true);
  ...
  for delete
  to authenticated
using (((bucket_id = 'event-banners'::text) AND public.current_user_has_permission('events.edit'::text)));
  ...
  for insert
  to authenticated
with check (((bucket_id = 'event-banners'::text) AND public.current_user_has_permission('events.edit'::text)));
...
using ((bucket_id = 'event-banners'::text));
  ...
  for delete
  to authenticated
using (((bucket_id = 'store-item-images'::text) AND public.current_user_has_permission('store.manage'::text)));
  ...
  for insert
  to authenticated
with check (((bucket_id = 'store-item-images'::text) AND public.current_user_has_permission('store.manage'::text)));
...
using (((bucket_id = 'store-item-images'::text) AND public.current_user_has_permission('store.manage'::text)));
  ...
  for select
  to public
using ((bucket_id = 'store-item-images'::text));
