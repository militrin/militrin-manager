-- 032_fix_active_create_registration_overload.sql
-- Overload canônica atual de create_registration usada pelo fluxo público com ticket_category_id.
-- Mantém payment_method apenas em public.payments; participants não possui essa coluna.
